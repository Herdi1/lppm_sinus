...
return new class extends Migration
{
    ...
    {
        Schema::create('output_results', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('report_id')->references('id')->on('progress_reports')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('output_results');
    }
};
